...
import com.example.paisefy_moneymanager.databinding.FragmentAccountBinding
...
class AccountFragment : Fragment() {
    ...
    private fun updateTransactionAmounts(transactions: List<Transaction>) {
        ...
        updateAccountAmounts(transactions, "Bank", binding.bankIncomeAmountText, binding.bankExpenseAmountText)
